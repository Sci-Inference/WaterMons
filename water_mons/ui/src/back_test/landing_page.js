...
class BackTest_Landing_Page extends React.Component {
  constructor(props) {
    super(props);
  ...
  async componentDidMount() {
    let data = await fetch('http://localhost:5000/db/getBacktest')
      .then(res => res.json())
...
export default withRouter(BackTest_Landing_Page);
